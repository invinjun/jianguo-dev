...
import com.woniukeji.jianguo.activity.mine.MineFragment;
import com.woniukeji.jianguo.activity.partjob.PartJobFragment;
...
//          loadingView = (CircleLoadingView) findViewById(R.id.loading);
        ...
        //重置定位状态 下次启动定位
        SPUtils.setParam(this,Constants.LOGIN_INFO,Constants.USER_CHOOSED_LOCATION,0);
        if (login){

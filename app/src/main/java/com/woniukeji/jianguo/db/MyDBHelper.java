...
public class MyDBHelper extends SQLiteOpenHelper{
    ...
    public MyDBHelper(Context context) {
         ...
         */
        super(context, "jianguo.db", null, 2);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table cityinfo (id integer primary key autoincrement, cityName varchar(20), cityCode varchar(20) UNIQUE,isSelected varchar(20))");
        db.execSQL("create table areainfo (id integer primary key autoincrement, areaName varchar(20), areaCode varchar(20) UNIQUE,parentCode varchar(20))");
        db.execSQL("create table typeinfo (id integer primary key autoincrement, typeName varchar(20), typeCode varchar(20) UNIQUE)");
...
//        db.execSQL("alter table cityinfo add account varchar(20)");
    }
}
